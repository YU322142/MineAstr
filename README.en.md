...
The integration between MineAstr 0.6.29 and Immersive Paintings 0.7.15 is jointly maintained by these two community forks. It is not an official integration supplied by either upstream project. Report related issues to the corresponding fork.
...
1. Put `mineastr-neoforge-1.21.1-0.6.29.jar` in the server's `mods/` directory.
...
Version 0.6.29 gives signs, entities, and Immersive Paintings one unified “current crosshair target” lifecycle:
...
- MineAstr `0.6.29` on both client and server.
...
| Signs work but paintings do not translate | Immersive Paintings 0.7.15 and whether MineAstr 0.6.29 is also installed on the client |
