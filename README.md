...
- AstrBot 插件：`0.6.15`
- MineAstr Fabric Mod：`0.6.12`
- Minecraft：`1.21.11`
- Fabric API：`0.141.4+1.21.11`

成品请从 [GitHub Releases](https://github.com/YU322142/MineAstr/releases) 下载：

- `astrbot_plugin_mineastr-v0.6.15.zip`
  - `mineastr-fabric-0.6.12.jar`

v0.6.15 是独立的新版本线，包含 Discord 消息编辑同步、QQ/Discord 同文去重，以及准星目标式告示牌世界浮选翻译。旧版 v0.6.14 / 0.6.11 保留不变。
